			...
			Device.prototype.render = function (camera, meshes) {
				...
				for (var index = 0; index < meshes.length; index++) {
					...
					for (var indexFaces = 0; indexFaces < cMesh.Faces.length; indexFaces++) {
						// First, we project the 3D coordinates into the 2D space
						var p1 = this.project(cMesh.Vertices[cMesh.Faces[indexFaces].A], transformMatrix)
						var p2 = this.project(cMesh.Vertices[cMesh.Faces[indexFaces].B], transformMatrix)
						var p3 = this.project(cMesh.Vertices[cMesh.Faces[indexFaces].C], transformMatrix)
						// Then we can draw on screen
						this.drawBline(p1, p2);
						this.drawBline(p2, p3);
						this.drawBline(p3, p1);
					}
